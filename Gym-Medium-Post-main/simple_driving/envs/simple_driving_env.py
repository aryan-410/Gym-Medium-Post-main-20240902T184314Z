...
class SimpleDrivingEnv(gym.Env):
    ...
    def reset(self):
        ...
        x = (self.np_random.uniform(low = 5, high = 9) if self.np_random.integers(2) else
             self.np_random.uniform(high = -5, low = -9))
        y = (self.np_random.uniform(low = 5, high = 9) if self.np_random.integers(2) else
             self.np_random.uniform(high = -5, low = -9))
        self.goal = (x, y)
        self.done = False
